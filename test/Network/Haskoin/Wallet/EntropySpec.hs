...
diceSpec =
  describe "Base6" $ do
    it "Base6 decoding vectors" $ do
      ...
      decodeBase6
        "161254362643213454433626115643626632163246612666332415423213664"
    ...
    it "can convert dice rolls to entropy" $ do
      ...
      diceToEntropy
        32
        "666655555555555555555544444444444444444444444333333333333333333322222222222222222111111111111111111"
        `shouldBe` Right
          ( fromJust $
              decodeHex
